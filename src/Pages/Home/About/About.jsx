                    ...
                    <div
                        ...
                        <div className="mt-10 lg:mt-20 lg:flex lg:items-center">
                            ...
                            <div className="mt-8 lg:px-10 lg:mt-0">
                               <button disabled className="text-2xl px-6   py-2 bg-gradient-to-r rounded-md shadow-2xl text-white font-serif from-blue-600 to-indigo-900">10 Years Experience</button>
