...
const Banner = () => {
    ...
    return (
        ...
        >
            ...
            <SwiperSlide>
                <img className='object-cover w-full h-screen bg-black opacity-90' src="./banner0 (2).jpg" alt="" />
                <div>
                    <div style={overlayStyles}></div>
                    <div className="absolute inset-0 flex items-center justify-center text-white lg:text-8xl font-mono font-bold">
            ...
            <SwiperSlide>
                <img className='object-cover w-full h-screen bg-black opacity-90' src="./banner0 (3).jpg" alt="" />
                <div>
                    <div style={overlayStyles}></div>
                    <div className="absolute inset-0 flex items-center justify-center text-white lg:text-8xl font-mono font-bold">
            ...
            <SwiperSlide>
                <img className='object-cover w-full h-screen bg-black opacity-90' src="./banner0 (4).jpg" alt="" />
                <div>
                    <div style={overlayStyles}></div>
                    <div className="absolute inset-0 flex items-center justify-center text-white lg:text-8xl font-mono font-bold">
            ...
            <SwiperSlide>
                <img className='object-cover w-full h-screen bg-black opacity-90' src="./banner0 (5).jpg" alt="" />
                <div>
                    <div style={overlayStyles}></div>
                    <div className="absolute inset-0 flex items-center justify-center text-white lg:text-8xl font-mono font-bold">
            ...
            <SwiperSlide>
                <img className='object-cover w-full h-screen bg-black opacity-90' src="./banner0 (6).jpg" alt="" />
                <div>
                    <div style={overlayStyles}></div>
                    <div className="absolute inset-0 flex items-center justify-center text-white lg:text-8xl font-mono font-bold">
            ...
            <SwiperSlide>
                <img className='object-cover w-full h-screen bg-black opacity-90' src="./banner0 (7).jpg" alt="" />
                <div>
                    <div style={overlayStyles}></div>
                    <div className="absolute inset-0 flex items-center justify-center text-white lg:text-8xl font-mono font-bold">
            ...
            <SwiperSlide>
                <img className='object-cover w-full h-screen bg-black opacity-90' src="./banner0 (8).jpg" alt="" />
                <div>
                    <div style={overlayStyles}></div>
                    <div className="absolute inset-0 flex items-center justify-center text-white lg:text-8xl font-mono font-bold">
            ...
            <SwiperSlide>
                <img className='object-cover w-full h-screen bg-black opacity-90' src="./banner0 (9).jpg" alt="" />
                <div>
                    <div style={overlayStyles}></div>
                    <div className="absolute inset-0 flex items-center justify-center text-white lg:text-8xl font-mono font-bold">
            ...
            <SwiperSlide>
                <img className='object-cover w-full h-screen bg-black opacity-90' src="./banner0 (10).jpg" alt="" />
                <div>
                    <div style={overlayStyles}></div>
                    <div className="absolute inset-0 flex items-center justify-center text-white lg:text-8xl font-mono font-bold">
