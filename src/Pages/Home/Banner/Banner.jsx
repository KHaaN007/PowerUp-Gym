        ...
        >
            ...
            <SwiperSlide>
                ...
                <div className='absolute z-50 bottom-44 left-96'>
                    <Link to="/classes">
                        <button className="btn border-0 relative mt-8 flex h-[50px] w-48 items-center justify-center overflow-hidden bg-blue-600 font-medium text-white shadow-2xl transition-all rounded-lg duration-300 before:absolute before:inset-0 before:border-0 before:border-white before:duration-100 before:ease-linear hover:bg-white font-serif text-xl px-2 hover:text-blue-600 hover:shadow-blue-600 hover:before:border-[25px]">
