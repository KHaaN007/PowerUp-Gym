...
const RecommendedClasses = () => {
    ...
    return (
        <div>
            ...
            <div className="">
                <h2 className="sm:text-6xl  max-w-6xl text-3xl lg:py-10 font-extrabold mb-16 text-gray-400 shadow-2xl p-5 border-r-4 rounded-lg">RECOMMENDED CLASSES</h2>

                <div className='mx-10'>

                    <div

                        className="grid lg:grid-cols-3 grid-cols-1 container  gap-10 lg:py-32 ">
                        {
